...
ActId = NewType("ActId", UUID)
SequenceId = NewType("SequenceId", UUID)
...
EmailVerificationId = NewType("EmailVerificationId", UUID)
PasswordResetId = NewType("PasswordResetId", UUID)
