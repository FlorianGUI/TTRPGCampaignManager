 ...
 * actually be read. Iterate on src/design-system/tokens/ and look here.
 *
 * For the exhaustive token and component reference, see /styleguide — this page
 * is the opposite: a small amount of everything, arranged the way it will be
 * read. Expected to be replaced by real routes once features arrive.
 */
    ...
    <div class="page__main">
      ...
      <div class="prose">
        <p>
          ...
          interest whatsoever in negotiation. The larger of the pair is scarred across the beak — a
          detail worth mentioning, because
